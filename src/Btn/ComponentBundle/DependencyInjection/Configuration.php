        ...
        $rootNode
            ->children()
                ...
                ->arrayNode('component')
                    ->addDefaultsIfNotSet()
                    ->children()
                        ->scalarNode('class')->isRequired()->defaultValue('Btn\\ComponentBundle\\Entity\\Component')->end()
                ...
                ->arrayNode('container')
                    ->addDefaultsIfNotSet()
                    ->children()
                        ->scalarNode('class')->defaultValue('Btn\\ComponentBundle\\Entity\\Container')->end()
